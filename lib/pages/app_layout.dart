    ...
    return BlocBuilder<AppCubit, AppState>(
      builder: (context, appState) {
        return BlocBuilder<AuthBloc, AuthState>(builder: (context, authState) {
          ...
          // TODO: if primary key is tasks, get the folders, and add them to the secondary section items at the right place (4th), after all folders
            ...
            children: [
              Expanded(
                child: Scaffold(
                  ...
                  // DONE: else show the primary item body
                  body: body,
